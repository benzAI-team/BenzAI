...
public class RunNbHexagons {
	...
	private static void usage() {
		System.out.println("usage : java -jar RunNbHexagons.jar nbHexagons");
	}
	...
	public static void main(String [] args) {
		...
		if (args.length != 1)
			...
			GeneralModel model = new GeneralModel(criterions, criterions, map, nbMaxCrowns);
			model.solve();

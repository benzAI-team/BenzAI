...
import utils.Coords;
import utils.Couple;
import modelProperty.SymmetryHandler;

public class SymmetryTester extends Tester {
	...
	public boolean test(Molecule molecule, ArrayList<PropertyExpression> propertyExpressionList, ModelPropertySet modelPropertySet) {
		...
		case "D_6h \"(vertex)-60-rotation+(edge)-mirror\"" : 
			return SymmetryHandler.hasRot60Symmetry(moleculeIndices, couronnes) && SymmetryHandler.hasHexagonAxisSymmetry(moleculeIndices, couronnes);
		...
		case "D_2h(i) \"face-180-rotation+edge-mirror\"" :
			return SymmetryHandler.hasRot180Symmetry(moleculeIndices, couronnes) && ! SymmetryHandler.hasRot60Symmetry(moleculeIndices, couronnes) && SymmetryHandler.hasHexagonAxisSymmetry(moleculeIndices, couronnes); 
		...
		case "C_2v(a) \"face-mirror\"" :
			return SymmetryHandler.hasHexagonAxisSymmetry(moleculeIndices, couronnes) && ! SymmetryHandler.hasRot180Symmetry(moleculeIndices, couronnes) && ! SymmetryHandler.hasRot120Symmetry(moleculeIndices, couronnes);
		...
		case "C_2h(i) \"face-180-rotation\"" :
			return SymmetryHandler.hasRot180Symmetry(moleculeIndices, couronnes) && ! SymmetryHandler.hasRot60Symmetry(moleculeIndices, couronnes) && ! SymmetryHandler.hasHexagonAxisSymmetry(moleculeIndices, couronnes) && ! SymmetryHandler.hasEdgeAxisSymmetry(moleculeIndices, couronnes);

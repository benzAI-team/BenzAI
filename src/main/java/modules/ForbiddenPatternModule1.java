...
public class ForbiddenPatternModule1 extends Module{
	...
	public ForbiddenPatternModule1(Pattern pattern, VariableStrategy variableStrategy, ValueStrategy valueStrategy, OrderStrategy orderStrategy) {
		super();

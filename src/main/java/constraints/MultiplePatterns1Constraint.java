...
public class MultiplePatterns1Constraint extends BenzAIConstraint {
	...
	public void buildVariables() {
		...
		ArrayList<ArrayList<Integer>> allUnknownHexagons = new ArrayList<>();
		ArrayList<ArrayList<Integer>> allPresentHexagons = new ArrayList<>();
		ArrayList<ArrayList<Integer>> allAbsentHexagons = new ArrayList<>();
